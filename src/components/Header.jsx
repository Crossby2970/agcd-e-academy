    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 sm:h-18 items-center justify-between">
          <a href="#home" className="flex items-center gap-2 font-heading font-extrabold text-navy text-lg sm:text-xl">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <a
              href="#programmes"
              className="rounded-full bg-broadcast-blue text-white text-sm font-semibold px-5 py-2.5 hover:bg-navy transition-colors"
            >
              Start Learning
            </a>
            <a
              href="#partners"
              className="rounded-full border-2 border-gold text-navy text-sm font-semibold px-5 py-2.5 hover:bg-gold hover:text-navy transition-colors"
            >
              Partner With Us
            </a>
          </div>
        ...
        >
          ...
          <div className="mt-4 flex flex-col gap-3">
            <a
              href="#programmes"
              onClick={() => setOpen(false)}
              className="rounded-full bg-broadcast-blue text-white text-sm font-semibold px-5 py-3 text-center hover:bg-navy transition-colors"
            >
              Start Learning
            </a>
            <a
              href="#partners"
              onClick={() => setOpen(false)}
              className="rounded-full border-2 border-gold text-navy text-sm font-semibold px-5 py-3 text-center hover:bg-gold transition-colors"
            >
              Partner With Us
            </a>
          </div>
